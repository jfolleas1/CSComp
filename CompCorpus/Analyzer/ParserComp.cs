...
// GPPG version 1.5.2
// Machine:  FIDF3675368
// DateTime: 19/06/2017 13:28:15
// UserName: j.folleas
// Input file <ParserComp.y - 19/06/2017 13:28:11>
...
public enum Tokens {error=2,EOF=3,TITREACTEKW=4,TRUE=5,FALSE=6,
    ...
    STRING=31,INTEGER=32,FLOAT=33,DEADWORD=34};
...
{
  // Verbatim content from ParserComp.y - 19/06/2017 13:28:11
    
    public Montage montage = new Montage();

  // End verbatim content from ParserComp.y - 19/06/2017 13:28:11
...
#pragma warning restore 649
  ...
  private static string[] nonTerms = new string[] {
      ...
      "brick", "document", "listBrick", "callVar", "$accept", };

  static Parser() {
    states[0] = new State(new int[]{4,80,3,-2},new int[]{-1,1,-7,3});
    states[1] = new State(new int[]{3,2});
    states[2] = new State(-1);
    states[3] = new State(-9,new int[]{-13,4});
    states[4] = new State(new int[]{26,5,30,79},new int[]{-12,71,-9,72});
    states[5] = new State(-14,new int[]{-6,6});
    states[6] = new State(new int[]{26,9,30,64,3,-39},new int[]{-17,7,-2,8,-5,31});
    states[7] = new State(-3);
    states[8] = new State(-15);
    states[9] = new State(-41,new int[]{-18,10});
    states[10] = new State(new int[]{34,14,30,15,7,16,12,17,13,18,25,19,32,20,33,21,31,22,28,23,29,24,27,27,3,-40},new int[]{-16,11,-14,12,-15,25,-19,26});
    states[11] = new State(-42);
    states[12] = new State(new int[]{34,14,30,15,7,16,12,17,13,18,25,19,32,20,33,21,31,22,28,23,29,24,27,-43,3,-43},new int[]{-15,13});
    ...
    states[24] = new State(-57);
    states[25] = new State(-45);
    ...
    states[31] = new State(new int[]{30,70,24,-18},new int[]{-11,32,-10,69});
    states[32] = new State(new int[]{24,33});
    states[33] = new State(new int[]{18,58,12,60,30,64,32,66,33,67,31,68},new int[]{-3,34,-5,63,-4,65});
    states[34] = new State(new int[]{25,35,8,36,10,38,11,40,9,42,16,44,17,46,19,48,20,50,21,52,22,54,23,56});
    states[35] = new State(-16);
    states[36] = new State(new int[]{18,58,12,60,30,64,32,66,33,67,31,68},new int[]{-3,37,-5,63,-4,65});
    states[37] = new State(new int[]{8,-20,10,38,11,40,9,-20,16,-20,17,-20,19,-20,20,-20,21,-20,22,-20,23,-20,25,-20,13,-20});
    states[38] = new State(new int[]{18,58,12,60,30,64,32,66,33,67,31,68},new int[]{-3,39,-5,63,-4,65});
    states[39] = new State(-21);
    states[40] = new State(new int[]{18,58,12,60,30,64,32,66,33,67,31,68},new int[]{-3,41,-5,63,-4,65});
    states[41] = new State(-22);
    states[42] = new State(new int[]{18,58,12,60,30,64,32,66,33,67,31,68},new int[]{-3,43,-5,63,-4,65});
    states[43] = new State(new int[]{8,-23,10,38,11,40,9,-23,16,-23,17,-23,19,-23,20,-23,21,-23,22,-23,23,-23,25,-23,13,-23});
    states[44] = new State(new int[]{18,58,12,60,30,64,32,66,33,67,31,68},new int[]{-3,45,-5,63,-4,65});
    states[45] = new State(new int[]{8,36,10,38,11,40,9,42,16,-24,17,-24,19,48,20,50,21,52,22,54,23,56,25,-24,13,-24});
    states[46] = new State(new int[]{18,58,12,60,30,64,32,66,33,67,31,68},new int[]{-3,47,-5,63,-4,65});
    states[47] = new State(new int[]{8,36,10,38,11,40,9,42,16,-25,17,-25,19,48,20,50,21,52,22,54,23,56,25,-25,13,-25});
    states[48] = new State(new int[]{18,58,12,60,30,64,32,66,33,67,31,68},new int[]{-3,49,-5,63,-4,65});
    states[49] = new State(new int[]{8,36,10,38,11,40,9,42,16,-27,17,-27,19,-27,20,-27,21,-27,22,-27,23,-27,25,-27,13,-27});
    states[50] = new State(new int[]{18,58,12,60,30,64,32,66,33,67,31,68},new int[]{-3,51,-5,63,-4,65});
    states[51] = new State(new int[]{8,36,10,38,11,40,9,42,16,-28,17,-28,19,-28,20,-28,21,-28,22,-28,23,-28,25,-28,13,-28});
    states[52] = new State(new int[]{18,58,12,60,30,64,32,66,33,67,31,68},new int[]{-3,53,-5,63,-4,65});
    states[53] = new State(new int[]{8,36,10,38,11,40,9,42,16,-29,17,-29,19,-29,20,-29,21,-29,22,-29,23,-29,25,-29,13,-29});
    states[54] = new State(new int[]{18,58,12,60,30,64,32,66,33,67,31,68},new int[]{-3,55,-5,63,-4,65});
    states[55] = new State(new int[]{8,36,10,38,11,40,9,42,16,-30,17,-30,19,-30,20,-30,21,-30,22,-30,23,-30,25,-30,13,-30});
    states[56] = new State(new int[]{18,58,12,60,30,64,32,66,33,67,31,68},new int[]{-3,57,-5,63,-4,65});
    states[57] = new State(new int[]{8,36,10,38,11,40,9,42,16,-31,17,-31,19,-31,20,-31,21,-31,22,-31,23,-31,25,-31,13,-31});
    states[58] = new State(new int[]{18,58,12,60,30,64,32,66,33,67,31,68},new int[]{-3,59,-5,63,-4,65});
    states[59] = new State(new int[]{8,36,10,38,11,40,9,42,16,-26,17,-26,19,48,20,50,21,52,22,54,23,56,25,-26,13,-26});
    states[60] = new State(new int[]{18,58,12,60,30,64,32,66,33,67,31,68},new int[]{-3,61,-5,63,-4,65});
    states[61] = new State(new int[]{13,62,8,36,10,38,11,40,9,42,16,44,17,46,19,48,20,50,21,52,22,54,23,56});
    ...
    states[72] = new State(new int[]{30,70},new int[]{-10,73});
    states[73] = new State(new int[]{25,74,14,75});
    states[74] = new State(-11);
    states[75] = new State(-9,new int[]{-13,76});
    states[76] = new State(new int[]{15,77,30,79},new int[]{-12,71,-9,72});
    states[77] = new State(new int[]{25,78});
    states[78] = new State(-12);
    states[79] = new State(-13);
    states[80] = new State(new int[]{14,81});
    states[81] = new State(new int[]{34,86,30,87},new int[]{-8,82});
    states[82] = new State(new int[]{15,83,34,84,30,85});
    ...
    rules[46] = new Rule(-14, new int[]{-14,-15});
    rules[47] = new Rule(-15, new int[]{34});
    rules[48] = new Rule(-15, new int[]{30});
    rules[49] = new Rule(-15, new int[]{7});
    rules[50] = new Rule(-15, new int[]{12});
    rules[51] = new Rule(-15, new int[]{13});
    rules[52] = new Rule(-15, new int[]{25});
    rules[53] = new Rule(-15, new int[]{32});
    rules[54] = new Rule(-15, new int[]{33});
    rules[55] = new Rule(-15, new int[]{31});
    rules[56] = new Rule(-15, new int[]{28});
    rules[57] = new Rule(-15, new int[]{29});
    rules[58] = new Rule(-19, new int[]{27,14,30,15});
  }
...
{ CurrentSemanticValue.brick = ValueStack[ValueStack.Depth-1].variableCall; }
        break;
      case 45: // textBloc -> textBlocElement
{ CurrentSemanticValue.String = ValueStack[ValueStack.Depth-1].String; }
        break;
      case 46: // textBloc -> textBloc, textBlocElement
{ CurrentSemanticValue.String = ValueStack[ValueStack.Depth-2].String; CurrentSemanticValue.String += (" " + ValueStack[ValueStack.Depth-1].String); }
        break;
      case 47: // textBlocElement -> DEADWORD
{ CurrentSemanticValue.String = ValueStack[ValueStack.Depth-1].String; }
        break;
      case 48: // textBlocElement -> ID
{ CurrentSemanticValue.String = ValueStack[ValueStack.Depth-1].String; }
        break;
      case 49: // textBlocElement -> DOLLAR
{ CurrentSemanticValue.String = "$"; }
        break;
      case 50: // textBlocElement -> PARENTOPEN
{ CurrentSemanticValue.String = "("; }
        break;
      case 51: // textBlocElement -> PARENTCLOSE
{ CurrentSemanticValue.String = ")"; }
        break;
      case 52: // textBlocElement -> SEMICOLON
{ CurrentSemanticValue.String = ";"; }
        break;
      case 53: // textBlocElement -> INTEGER
{ CurrentSemanticValue.String = ValueStack[ValueStack.Depth-1].Integer.ToString(); }
        break;
      case 54: // textBlocElement -> FLOAT
{ CurrentSemanticValue.String = ValueStack[ValueStack.Depth-1].Float.ToString(); }
        break;
      case 55: // textBlocElement -> STRING
{ CurrentSemanticValue.String = ValueStack[ValueStack.Depth-1].String; }
        break;
      case 56: // textBlocElement -> NOUVLIGNE
{ CurrentSemanticValue.String = "$nouvligne"; }
        break;
      case 57: // textBlocElement -> NOUVPARAG
{ CurrentSemanticValue.String = "$nouvparag"; }
        break;
      case 58: // callVar -> CODEINDIC, BRACEOPEN, ID, BRACECLOSE
